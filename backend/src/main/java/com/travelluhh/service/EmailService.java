    ...
    public void sendVerificationCode(String toEmail, String code, String purpose) {
        try {
            ...
            if ("signup".equals(purpose)) {
                helper.setSubject("TravelLuhh — Verify your email");
                helper.setText(buildSignupEmailHtml(code), true);
            } else {
                helper.setSubject("TravelLuhh — Reset your password");
    ...
    private String buildSignupEmailHtml(String code) {
        return """
            <div style="font-family: sans-serif; max-width: 480px; margin: auto; padding: 32px;">
              <h2 style="color: #1a1a1a;">Welcome to TravelLuhh ✈️</h2>
              ...
              <p style="color: #999; font-size: 12px; margin-top: 24px;">
                If you didn't sign up for TravelLuhh, you can safely ignore this email.
              </p>
            </div>
            """.formatted(code);
    }
    ...
    private String buildResetEmailHtml(String code) {
        return """
            <div style="font-family: sans-serif; max-width: 480px; margin: auto; padding: 32px;">
              ...
              <p style="color: #555;">Enter the code below in TravelLuhh to reset your password. It expires in <strong>10 minutes</strong>.</p>
              <div style="font-size: 36px; font-weight: bold; letter-spacing: 8px; color: #4f46e5;
                          background: #f0f0ff; border-radius: 8px; padding: 20px; text-align: center;">
                %s
              </div>
